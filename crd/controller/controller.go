...
import (
	...
	restservicev1 "github.com/Rest-service/crd/pkg/apis/restservicecontroller/v1"
	clientset "github.com/Rest-service/crd/pkg/client/clientset/versioned"
	restservicescheme "github.com/Rest-service/crd/pkg/client/clientset/versioned/scheme"
	informers "github.com/Rest-service/crd/pkg/client/informers/externalversions"
	listers "github.com/Rest-service/crd/pkg/client/listers/restservicecontroller/v1"
)
...
func (c *Controller) syncHandler(key string) error {
	...
	// out := getPods(c, deploymentName, namespaceName)
...
func updateCRD(foo *restservicev1.RestService, c *Controller, setupCommands []string) {
...
func getPods(c *Controller, deploymentName, namespace string) *apiv1.PodList {
